...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/27 19:45:27 by mdiallo           #+#    #+#             */
/*   Updated: 2021/04/27 19:45:29 by mdiallo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_sprite(t_window *win_infos, t_sprite *sprites, int nbr_sprites)
{
	int			i;
	double		dist_one;
	double		dist_two;
