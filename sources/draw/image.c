...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/27 19:44:48 by mdiallo           #+#    #+#             */
/*   Updated: 2021/04/27 19:44:50 by mdiallo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ver_line_color_image(t_line *line, t_window *win_infos, int color)
{
	int	y;
	int	y_max;
...
static void	texture_on_img(t_line *line, t_image *texture,
	t_window *win_infos, t_ray *ray)
{
	int	d;
...
void	ver_line_texture_image(t_line *line, t_window *win_infos,
...
t_image	*new_image(t_window *win_infos, int x_len, int y_len)
{
	...
	img->img_ptr = mlx_new_image(win_infos->mlx_ptr, x_len, y_len);
	if (!(img->img_ptr))
		return ((void *)0);
