...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/27 19:45:36 by mdiallo           #+#    #+#             */
/*   Updated: 2021/04/27 19:45:38 by mdiallo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3d.h"

static void	determine_side_draw(t_ray *ray, t_window *win_infos,
...
int	set_texture(t_window *win_infos, const char *path, int texture_index)
{
	win_infos->textures[texture_index]->img_ptr = \
